...
def main():
    # Configuration
    if True:
        modelFile          = '/home/vedhas/workspace/is2019_recurrence/DHCresults/8/m531_tr0.646_dv0.600_ts0.602_tc0.413.h5'#'/home/vedhas/workspace/is2019_recurrence/results/8_oV_iv/m498_tr0.647_dv0.560_ts0.581_tc0.375.h5'
        culture            = 'German'
        eval_cross         = True
        modality           = 'video'
