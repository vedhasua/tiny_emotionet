    ...
    while epoch <= max_num_epochs:
        ...
        if eval_cross:
            ...
            if CCC_orig_devel==cccmax:
                ...
                model.save("m{}_tr{:.3f}_dv{:.3f}_ts{:.3f}_tc{:.3f}.h5".format(epoch, CCC_orig_train[0], CCC_orig_devel[0], CCC_orig_test[0], CCC_orig_testC[0]))
                lastsaved=epoch
            if CCC_orig_devel>cccmax:
                cccmax=CCC_orig_devel
                model.save("m{}_tr{:.3f}_dv{:.3f}_ts{:.3f}_tc{:.3f}.h5".format(epoch, CCC_orig_train[0], CCC_orig_devel[0], CCC_orig_test[0], CCC_orig_testC[0]))
            ...
            print("CCC train: {:.3f},{:.3f},{:.3f}, ".format(CCC_train[0],CCC_orig_train[0],CCC_orig_train_seq[0]) + \
                  "CCC devel: {:.3f},{:.3f},{:.3f}, ".format(CCC_devel[0],CCC_orig_devel[0],CCC_orig_devel_seq[0],CCC_orig_devel_pp[0]) + \
                  "CCC test:  {:.3f},{:.3f},{:.3f}, ".format(CCC_test[0], CCC_orig_test[0], CCC_orig_test_seq[0], CCC_orig_test_pp[0] ) + \
                  "CCC testC: {:.3f},{:.3f},{:.3f}".format(  CCC_testC[0],CCC_orig_testC[0],CCC_orig_test_seqC[0],CCC_orig_test_ppC[0]))
        else:
